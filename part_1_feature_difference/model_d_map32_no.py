...
def features_matching(inputs_p1, inputs_p2):
    with tf.variable_scope("matching"):
        layers_1,feature_map_1 = features(inputs_p1, 'feature_layers_1') # 4*4*256
        layers_2,feature_map_2 = features(inputs_p2, 'feature_layers_2') # 4*4*256
