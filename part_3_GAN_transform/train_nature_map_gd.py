...
import model_gd_diff as model_g
...
checkpoint_dir = 'ckpt_map_gd'
checkpoint_file = os.path.join(checkpoint_dir, 'model.ckpt')
checkpoint_dir_g = 'ckpt_g_g2r'
checkpoint_file_g = os.path.join(checkpoint_dir_g+'_country', 'model.ckpt')
train_dir='summary'

def initLogging(logFilename='record_map_gd.log'):
  """Init for logging
  """
  logging.basicConfig(
                    level    = logging.DEBUG,
    ...
    with graph.as_default():
        ...
        with tf.Session() as sess:
            ...
            try:
                ...
                np.save(os.path.join(checkpoint_dir,'ckpt_map_gd'), all_loss)
